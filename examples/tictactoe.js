...
var ASM_CONSTS = {
  92984: () => { if (document.fullscreenElement) return 1; },  
 93030: () => { return document.getElementById('canvas').width; },  
 93082: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93150: () => { document.exitFullscreen(); },  
 93177: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93250: () => { if (document.fullscreenElement) return 1; },  
 93296: () => { return document.getElementById('canvas').width; },  
 93348: () => { return screen.width; },  
 93373: () => { document.exitFullscreen(); },  
 93400: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93533: () => { return window.innerWidth; },  
 93559: () => { return window.innerHeight; },  
 93586: () => { if (document.fullscreenElement) return 1; },  
 93632: () => { return document.getElementById('canvas').width; },  
 93684: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93752: () => { if (document.fullscreenElement) return 1; },  
 93798: () => { return document.getElementById('canvas').width; },  
 93850: () => { return screen.width; },  
 93875: () => { return window.innerWidth; },  
 93901: () => { return window.innerHeight; },  
 93928: () => { if (document.fullscreenElement) return 1; },  
 93974: () => { return document.getElementById('canvas').width; },  
 94026: () => { return screen.width; },  
 94051: () => { document.exitFullscreen(); },  
 94078: () => { if (document.fullscreenElement) return 1; },  
 94124: () => { return document.getElementById('canvas').width; },  
 94176: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94244: () => { document.exitFullscreen(); },  
 94271: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94329: () => { return screen.width; },  
 94354: () => { return screen.height; },  
 94380: () => { return window.screenX; },  
 94407: () => { return window.screenY; },  
 94434: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94487: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 94558: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 94615: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94871: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 94942: () => { if (document.fullscreenElement) return 1; },  
 94988: () => { return window.innerWidth; },  
 95014: () => { return window.innerHeight; },  
 95041: () => { if (document.pointerLockElement) return 1; }
};
