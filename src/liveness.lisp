...
(defun instr-uses (i)
  ...
  (case (ir-instr-op i)
    ...
    (:field-get     (list (first (ir-instr-args i))))
    (:field-set     (list (first (ir-instr-args i)) (third (ir-instr-args i))))
    (:field-get-ptr (list (first (ir-instr-args i))))
    (:field-set-ptr (list (first (ir-instr-args i)) (third (ir-instr-args i))))))
